  ...
  describe('POST /api/admin/members/batch', () => {
    it('should batch update member statuses', async () => {
      ...
      await env.DB.exec(`
        INSERT INTO members (first_name, last_name, email, enrollment_track, status, discord)
        VALUES
          ('User1', 'Test', 'user1@example.com', 'L3 Informatique', 'pending', '@user1'),
          ('User2', 'Test', 'user2@example.com', 'L3 Informatique', 'pending', '@user2'),
          ('User3', 'Test', 'user3@example.com', 'L3 Informatique', 'pending', '@user3')
      `);
  ...
  describe('GET /api/admin/export', () => {
    ...
    it('should filter export by status', async () => {
      await env.DB.exec(`
        INSERT INTO members (first_name, last_name, email, enrollment_track, status, discord)
        VALUES
          ('Active', 'User', 'active@example.com', 'L3 Informatique', 'active', '@active'),
          ('Pending', 'User', 'pending@example.com', 'L3 Informatique', 'pending', '@pending')
      `);
